...
def test_config_multiple(config_tmpdir):
    ...
    # specify multiple configs for each config level
    os.environ["WEST_CONFIG_GLOBAL"] = f'{config_g1}:{config_g2}'
    os.environ["WEST_CONFIG_SYSTEM"] = f'{config_s1}:{config_s2}'
    os.environ["WEST_CONFIG_LOCAL"] = f'{config_l1}:{config_l2}'
